...
public class FilesRepositoryModule extends lebah.portal.velocity.VTemplate {
	...
	protected Template doTask(HttpSession session, String template_name) throws Exception, ResourceNotFoundException, ParseErrorException {
		...
		if ( "createfolder".equals(submit) ) {
            ...
            //only HTML file is allowed to be created
	    ...
	    public static class Resource {
			...
			public static String getImagePath() { return IMAGE; }
			public static String getFlashPath() { return FLASH; }
			public static String getImageUrl() { return IMAGEURL; }
			public static String getFlashUrl() { return FLASHURL; }
		...
		//This comparator
		public static class DatetimeComparator extends lebah.util.MyComparator {
