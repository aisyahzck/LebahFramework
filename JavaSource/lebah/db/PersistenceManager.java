...
public class PersistenceManager  {
	...
	*/
	...
	public PersistenceManager find(Class klas) throws Exception {
		this.klas = klas;
		return this;
	}	
	
	public PersistenceManager whereId(Object id) throws Exception {
		data = find(klas, id);
		return this;
	}
	...
	public Query getQuery(String pql) {
		return em.createQuery(pql);
	}
